...
/*CLK Src Configuration*/
	/*CLK Src*/
#define SCH_CLK_SRC		PLL							/*Options: HSI, HSE, PLL*/

	/*Whether to Bypass HSE Oscillator*/
#define SCH_OSCILLATOR_BYPASS		DIS_OSC_BYPASS	/*Options: EN_OSC_BYPASS, DIS_OSC_BYPASS*/

	/*Whether to Enable Clk Security System*/
#define SCH_CSS_ENABLE				DIS_CSS			/*Options: EN_CSS, DIS_CSS*/	
 ...
 * PLL input Freq = Frecuency of PLL input source					(chosen in SCH_PLL_SRC) 
